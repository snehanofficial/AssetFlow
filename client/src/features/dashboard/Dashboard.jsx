    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="card-elevation p-6 lg:col-span-2 space-y-4">
          <h3 className="font-semibold text-sm">Asset Allocation Trends</h3>
          <div className="h-64 bg-slate-900/50 rounded flex items-center justify-center text-slate-500 text-xs">
